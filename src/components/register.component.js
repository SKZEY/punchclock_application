    ...
    if (!value) {
        return (
            <div className="alert alert-danger" role="alert"
                ...
                <i className="fas fa-exclamation-circle"></i>  This field is required
            </div>
        );
    }
};
...
const email = value => {
    if (!isEmail(value)) {
        return (
            <div className="alert alert-danger" role="alert"
                 style={{margin: ".5rem, 0", fontSize: "12px", backgroundColor: "transparent", borderColor: "transparent", padding: "0", color: "#d93025"}}>
                <i className="fas fa-exclamation-circle"></i>  This is not a valid email.
            </div>
        );
    }
};
...
export default class Register extends Component {
    ...
    render() {
        return (
            <div className="col-md-12" style={{flex: "0"}}>
